...
from transformers import GPT2LMHeadModel, get_linear_schedule_with_warmup, PreTrainedTokenizerFast
...
def main(config: QGConfig):
    ...
    train_dataset = QGDataset(train_examples, tokenizer, max_sequence_length)
    ...
    # dev_dataset = QGDataset(dev_examples, tokenizer, max_sequence_length, is_train=False)
